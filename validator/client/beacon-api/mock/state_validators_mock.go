...
func (m *MockstateValidatorsProvider) GetStateValidatorsForSlot(arg0 context.Context, arg1 primitives.Slot, arg2 []string, arg3 []int64, arg4 []string) (*apimiddleware.StateValidatorsResponseJson, error) {
	m.ctrl.T.Helper()
